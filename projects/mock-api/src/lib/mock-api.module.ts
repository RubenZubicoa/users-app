import { APP_INITIALIZER, ModuleWithProviders, NgModule, TypeProvider } from '@angular/core';
...
export class FuseMockApiModule
{
     ...
     */
    static forRoot(mockApiServices: TypeProvider[], config?: { delay?: number }): ModuleWithProviders<FuseMockApiModule>
    {
        return {
